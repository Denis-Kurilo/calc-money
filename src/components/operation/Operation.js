...
const Operation = ({ addTransaction, addDescription, addAmount }) => {
  return(
    <section className="operation">
      ...
      <form id="form">
          <label>
              <input type="text" className="operation__fields operation__name" placeholder="Наименование операции" onChange={addDescription}/>
          </label>
          <label>
              <input type="number" className="operation__fields operation__amount" placeholder="Введите сумму" onChange={addAmount}/>
          </label>
